...
const EstimationDetails = ({ navigation, route }) => {
  ...
  const { estimateDetails } = route.params;  // Sample address estimateDetails
  ...
  const accountDetails = estimateDetails.branchAccount?.find(
    (account) => {
      console.log("ttt :", Number(account.id) + " === " + Number(estimateDetails.accountId))
          ...
          <View style={styles.pageBorder}>
            ...
            <View style={styles.header}>
              <View style={styles.logoContainer}>
                ...
                <View>
                  ...
                  <Text style={styles.companyDetails}> {estimateDetails.branchAddress}</Text>
            ...
            <View style={styles.detailsRow}>
              <View style={styles.detailsColumnLeft}>
                <Text style={styles.detailsText}>Quotation No.: {estimateDetails.estimateId}</Text>
