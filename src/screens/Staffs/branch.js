          ...
          <View style={styles.cardContent}>
            ...
            <View style={styles.barContainer}>
              ...
              <View style={{ height: 16, borderRadius: 5, marginBottom: 10, backgroundColor: '#27AE6030', width: '100%' }}>
                <View style={[styles.bar, { backgroundColor: '#27AE60', width: `${branch.cradits}%`, }]} />
              </View>
              ...
              <View style={{ height: 16, borderRadius: 5, marginBottom: 10, backgroundColor: '#E74C3C30', width: '100%' }}>
                <View style={[styles.bar, { backgroundColor: '#E74C3C', width: `${branch.debits}%` }]} />
              </View>
            </View>
            ...
            <Button
              ...
              onPress={() => {
                dispatch(drawLabel("Branch's"));
                navigation.navigate('BranchDetails', { branchDetails: branch });
              }}
