...
const SubStaffWorkDetails = ({ navigation, route }) => {
    ...
    useEffect(() => {
        const workdata = async () => {
          const staffid = await loadData("stafID");
          setStaffId(staffid);
          console.log("rrr : ",workDetails)
        };
      
        workdata(); // Call the async function
      }, []);
        ...
        <ScrollView style={styles.container}>
            ...
            {(workDetails.workStatus === "accept" || workDetails.workStatus === "activate") &&
                <Card style={styles.card}>
                    ...
                    <Card.Content>
                        {renderInfo("Staff Name", workDetails.backSupportterName)}
                        {renderInfo("Staff ID", workDetails.backSupporterId)}
                        {renderInfo("Department", "Tech Support")}
                        {renderInfo("Phone", workDetails.backSupportterPhoneNumber || "N/A")}
                        {renderInfo("Email", workDetails.backSupportterNameEmail || "N/A")}
...
export default SubStaffWorkDetails;
